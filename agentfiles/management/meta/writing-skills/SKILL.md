...
**Testing methodology** — write pressure scenarios that combine multiple simultaneous pressures
(time + sunk cost + authority + exhaustion). Run WITHOUT the skill to baseline, then WITH.
Plug any new rationalizations found and re-test until bulletproof.
