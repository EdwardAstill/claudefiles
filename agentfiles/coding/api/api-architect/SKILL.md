...
- `af routes --write` — extract full route map before review mode (always run this first in review mode)
- `af context --write` — understand project framework before designing
...
- `af note` — record API decisions so other agents can read them
