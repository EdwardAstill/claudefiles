...
### regex-expert
- **Purpose:** Mass search and replace, refactor symbol names across many files, clean up structured data
- **Use when:** Renaming classes/functions across project; complex regex replacements; cleaning up spacing/formatting
- **Produces:** Safely refactored codebase using sd/rg; committed
- **Chains into:** verification-before-completion
...
### tui-expert
- **Purpose:** Terminal UI design intelligence — layout in character grids, terminal color palettes, keyboard interaction, component states. Knows Textual, Ratatui, Ink, and Bubbletea widget catalogs.
- **Use when:** Building or iterating on a TUI; specifying terminal app layout, keybindings, and color scheme before writing code
- **Produces:** TUI Component Spec (layout diagram, color palette, keybindings, widget list, states); framework recommendation; handoff context for language expert
