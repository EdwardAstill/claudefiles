"""af screenshot — capture a browser screenshot Agent can read visually.
...
to view it — Agent sees the actual rendered layout, spacing, and colours.
"""
...
def main(
    ...
    """Screenshot a URL and save as PNG. Agent reads it with the Read tool."""
    if mobile:
